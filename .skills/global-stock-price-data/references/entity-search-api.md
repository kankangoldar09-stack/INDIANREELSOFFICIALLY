...
**Endpoint:** `GET https://app-af2z7g8d924h-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-af2z7g8d924h-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
