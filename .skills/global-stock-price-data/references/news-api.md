...
**Endpoint:** `GET https://app-af2z7g8d924h-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-af2z7g8d924h-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
